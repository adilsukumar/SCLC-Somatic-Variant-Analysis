...
* Identified somatic mutations using **GATK Mutect2** in Tumor-Only mode.
...
| --- | --- | --- |
| **Indel/Frameshift** | 85.7% 

 | <br>`TP53`, `CREBBP`, `EP300`, `COL22A1`, `PTEN`, `NOTCH3` 
...
Would you like me to add a section on how to specifically run the `Mutect2` command with the parameters used in your analysis?
